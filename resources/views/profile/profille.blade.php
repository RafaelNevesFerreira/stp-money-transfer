      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="bg-white shadow-sm rounded py-4 mb-4">
            ...
            <!-- View all Link
            =============================== -->
            <div class="text-center mt-4"><a href="http://demo.harnishdesign.net/html/payyed/transactions.html" class="btn-link text-3">View all<i class="fas fa-chevron-right text-2 ms-2"></i></a></div>
            <!-- View all Link End -->
