<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-lg d-lg-flex align-items-center">
                <ul class="nav justify-content-center justify-content-lg-start text-3">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{route("help")}}">Ajuda</a></li>
        ...
        <div class="footer-copyright pt-3 pt-lg-2 mt-2">
            <div class="row">
                <div class="col-lg">
                    <p class="text-center text-lg-start mb-2 mb-lg-0">Copyright &copy; 2022 <a href="#">Rafael Ferreira</a>. All
                        Rights Reserved.</p>
                </div>
                <div class="col-lg d-lg-flex align-items-center justify-content-lg-end">
                    <ul class="nav justify-content-center">
                        <li class="nav-item"> <a class="nav-link" href="{{route("privacity")}}">Privacidade</a></li>
                    </ul>
                </div>
            </div>
        </div>
